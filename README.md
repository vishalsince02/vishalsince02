...
* **Salesforce CRM** — Understanding of CRM concepts, Salesforce platform and business workflows
* **Apex** — Server-side Salesforce programming and business logic
* **Lightning Web Components (LWC)** — Building modern Salesforce UI components
* **SOQL** — Querying and working with Salesforce data
* **Salesforce Development** — Connecting business requirements with Salesforce solutions
* **Salesforce Admin Concepts** — Understanding of Salesforce configuration and platform capabilities

<br>

## 📈 Currently Working On

`Salesforce CRM` `Apex` `LWC` `SOQL` `Spring Boot` `Microservices` `Docker` `AWS Cloud` `Advanced DSA` `System Design`
